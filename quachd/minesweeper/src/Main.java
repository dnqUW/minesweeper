...
public class Main {
    ...
    public static String[][] minefieldSetup(final int rows, final int columns, final Scanner scanner) {
        ...
        for (int i = 0; i < rows; i++) {
            ...
            for (int j = 0; j < next.length(); j++) {
                minefield[i + 1][j + 1] = "" + next.charAt(j);  // Fill the inner minefield
            }
        }
        return minefield;
    }
    ...
    public static int produceHint(final int row, final int column, final String[][] minefield) {
    ...
    public static void printMinefield(final String[][] minefield, final int fieldNum) {
